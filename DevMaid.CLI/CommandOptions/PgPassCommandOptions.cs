...
/// <summary>
/// Opções para o subcomando <c>devmaid database pgpass add</c>.
/// </summary>
...
/// <summary>
/// Opções para o subcomando <c>devmaid database pgpass list</c>.
/// Sem parâmetros adicionais.
/// </summary>
public class PgPassListOptions { }

/// <summary>
/// Opções para o subcomando <c>devmaid database pgpass remove</c>.
/// </summary>
