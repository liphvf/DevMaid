...
- **QUANDO** um consumer solicita `GetDockerStatusAsync()`
...
- **QUANDO** um consumer solicita a inicialização de um container PostgreSQL com as opções fornecidas
...
- **QUANDO** qualquer consumer (CLI ou frontend) precisa referenciar o nome padrão do container, imagem ou configurações de locale
