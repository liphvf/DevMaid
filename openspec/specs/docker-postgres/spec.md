...
Expor o subcomando `devmaid docker postgres` que provisiona e inicia um container PostgreSQL local configurado para desenvolvimento em ambiente brasileiro (pt-BR).
