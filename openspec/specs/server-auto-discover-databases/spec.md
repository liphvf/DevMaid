...
Define o comportamento de auto-descoberta de databases por servidor, incluindo patterns de exclusão configuráveis, a query usada para listagem e validação de acessibilidade de databases descobertas.
