# Spec: query-run-destructive-detection

## Purpose

Define o comportamento de detecção de queries destrutivas e o fluxo de confirmação interativa antes de executar comandos SQL que modificam dados ou schema em múltiplos servidores.
