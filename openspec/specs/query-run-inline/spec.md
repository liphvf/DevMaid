# Spec: query-run-inline

## Purpose

Define o comportamento de aceitação de queries SQL via linha de comando com o parâmetro `-c`, validação de exclusão mútua com `-i`, e validação de arquivos SQL fornecidos.
