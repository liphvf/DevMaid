# Spec: query-run-csv-export

## Purpose

Define o comportamento de exportação de resultados de query para arquivos CSV, incluindo formato das colunas, path de output padrão e suporte a múltiplos servidores.
