# Spec: query-run-progress-feedback

## Purpose

Define o comportamento de feedback visual ao usuário durante a execução de queries: progress bar com contagem de databases processadas, feed de atividades em tempo real mostrando queries completadas, e resumo final com caminhos dos arquivos gerados.

## Requirements

### Requirement: Progress bar com total de databases
...
### Requirement: Feed de atividades em tempo real
