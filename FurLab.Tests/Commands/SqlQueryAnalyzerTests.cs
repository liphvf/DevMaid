...
public class SqlQueryAnalyzerTests
{
    ...
    {
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("SELECT * FROM users"));
    }

    [TestMethod(DisplayName = "SHOW is classified as Safe")]
    public void AnalyzeQuery_Show_ReturnsSafe()
    {
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("SHOW tables"));
    }

    [TestMethod(DisplayName = "EXPLAIN is classified as Safe")]
    public void AnalyzeQuery_Explain_ReturnsSafe()
    {
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("EXPLAIN SELECT * FROM users"));
    }

    [TestMethod(DisplayName = "INSERT is classified as Destructive")]
    public void AnalyzeQuery_Insert_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("INSERT INTO users (name) VALUES ('test')"));
    }

    [TestMethod(DisplayName = "UPDATE is classified as Destructive")]
    public void AnalyzeQuery_Update_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("UPDATE users SET name = 'test' WHERE id = 1"));
    }

    [TestMethod(DisplayName = "DELETE is classified as Destructive")]
    public void AnalyzeQuery_Delete_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("DELETE FROM users WHERE id = 1"));
    }

    [TestMethod(DisplayName = "ALTER is classified as Destructive")]
    public void AnalyzeQuery_Alter_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("ALTER TABLE users ADD COLUMN email TEXT"));
    }

    [TestMethod(DisplayName = "DROP is classified as Destructive")]
    public void AnalyzeQuery_Drop_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("DROP TABLE users"));
    }

    [TestMethod(DisplayName = "CREATE is classified as Destructive")]
    public void AnalyzeQuery_Create_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("CREATE TABLE test (id INT)"));
    }

    [TestMethod(DisplayName = "TRUNCATE is classified as Destructive")]
    public void AnalyzeQuery_Truncate_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("TRUNCATE TABLE users"));
    }

    [TestMethod(DisplayName = "MERGE is classified as Destructive")]
    public void AnalyzeQuery_Merge_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("MERGE INTO target USING source ON (target.id = source.id) WHEN MATCHED THEN UPDATE SET target.val = source.val"));
    }

    [TestMethod(DisplayName = "GRANT is classified as Destructive")]
    public void AnalyzeQuery_Grant_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("GRANT SELECT ON users TO readonly"));
    }

    [TestMethod(DisplayName = "REVOKE is classified as Destructive")]
    public void AnalyzeQuery_Revoke_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("REVOKE SELECT ON users FROM readonly"));
    }

    [TestMethod(DisplayName = "SET ROLE is classified as Destructive")]
    public void AnalyzeQuery_SetRole_ReturnsDestructive()
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("SET ROLE admin"));
    }

    [TestMethod(DisplayName = "SET without ROLE is classified as Safe")]
    public void AnalyzeQuery_SetWithoutRole_ReturnsSafe()
    {
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("SET search_path TO public"));
    }

    [TestMethod(DisplayName = "Empty query is classified as Safe")]
    public void AnalyzeQuery_Empty_ReturnsSafe()
    {
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery(""));
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("   "));
    }
    ...
    {
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("-- This is a comment\nSELECT * FROM users"));
    }
    ...
    {
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("/* block comment */ SELECT * FROM users"));
    }
    ...
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("-- careful!\nDELETE FROM users"));
    }

    [TestMethod(DisplayName = "CTE with internal SELECT is classified as Safe")]
    public void AnalyzeQuery_CteWithSelect_ReturnsSafe()
    {
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("WITH temp AS (SELECT * FROM users) SELECT * FROM temp"));
    }
    ...
    {
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery("WITH temp AS (INSERT INTO users VALUES (1)) SELECT * FROM temp"));
    }
    ...
    {
        Assert.AreEqual("SELECT", SqlQueryAnalyzerService.GetQueryTypeDescription("select * from users"));
        Assert.AreEqual("DELETE", SqlQueryAnalyzerService.GetQueryTypeDescription("delete from users"));
    }
    ...
    {
        Assert.AreEqual("UNKNOWN", SqlQueryAnalyzerService.GetQueryTypeDescription(""));
    }
    ...
    public void AnalyzeQuery_MultipleCtes_SecondDestructive_ReturnsSafe_KnownLimitation()
    {
        ...
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery(query));
    }
    ...
    public void AnalyzeQuery_MultipleCtes_FirstDestructive_ReturnsDestructive()
    {
        ...
        Assert.AreEqual(QueryType.Destructive, SqlQueryAnalyzerService.AnalyzeQuery(query));
    }
    ...
    public void AnalyzeQuery_CteWithoutAs_ReturnsSafe()
    {
        ...
        Assert.AreEqual(QueryType.Safe, SqlQueryAnalyzerService.AnalyzeQuery("WITH cte SELECT * FROM cte"));
    }
}
